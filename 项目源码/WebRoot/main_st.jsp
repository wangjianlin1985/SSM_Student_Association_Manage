...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#01B1EA;">
	<div class="logo">基于ssm社团管理系统后台管理</div>
	<div class="logout">您好社团负责人：<%=session.getAttribute("st")%> | <a href="logout">退出</a></div>
</div>   
...
<script type="text/javascript" src="js/admin_st.js"></script>
