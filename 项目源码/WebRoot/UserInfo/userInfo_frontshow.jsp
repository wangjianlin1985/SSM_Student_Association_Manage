...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">学校学院:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getSchoolName()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">年级专业:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getSpecialInfo()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">民族:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getNation()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">政治面貌:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getPoliticalStatus()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">有兴趣的项目:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getInterest()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">个人介绍:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getIntroduce()%></div>
	</div>
	<div class="row bottom15">
