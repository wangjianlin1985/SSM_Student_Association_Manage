...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">SSM社团管理系统</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Team/frontlist">社团查询</a></li>
                <li><a href="<%=basePath %>Exercise/frontlist">活动列表</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>UserInfo/userInfo_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;用户注册</a></li>
	  			<li><a href="<%=basePath %>Team/team_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;社团注册</a></li>
                <li><a href="#" onclick="login();"><i class="fa fa-user"></i>&nbsp;&nbsp;用户登录</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>index.jsp"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;首页</a></li>
                         <li><a href="<%=basePath %>SignUp/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我报名的活动</a></li>
